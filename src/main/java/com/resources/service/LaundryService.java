...
public class LaundryService {
    ...
    public List<Customer> searchCustomers(String surname) {
        return customerDAO.searchCustomers(surname);
    }
    ...
    public boolean updateRemainingTime(Long id, Integer remainingTime) {
        return orderDAO.updateRemainingTime(id, remainingTime);
    }
